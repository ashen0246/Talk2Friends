...
public class BadEmailLoginTest {
    ...
    public void badPasswordLoginTest() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.enterEmail), withText("USC Email"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("alshen@usc.ed"));

        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.enterEmail), withText("alshen@usc.ed"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.errorMessage), withText("Invalid Login"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("Invalid Login")));
    }
